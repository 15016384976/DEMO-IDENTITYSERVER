    ...
    public partial class INIT : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceCode", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ApiResourceScopeClaim",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ApiResourceScopeId = table.Column<int>(nullable: false),
                    Type = table.Column<string>(maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApiResourceScopeClaim", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApiResourceScopeClaim_ApiResourceScope_ApiResourceScopeId",
                        column: x => x.ApiResourceScopeId,
                        principalTable: "ApiResourceScope",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiResourceScopeClaim_ApiResourceScopeId",
                table: "ApiResourceScopeClaim",
                column: "ApiResourceScopeId");
